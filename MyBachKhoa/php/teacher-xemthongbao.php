                               ...
                               <?php
                                    ...
                                    while($records=mysqli_fetch_array($result))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="./teacher-xuliphanhoithongbao.php?idnguoinhan=<?php echo $records['idnguoigui']."&tennguoinhan=".$records['tennguoigui']; ?>"><img width="30px;" src="../images/icon_phanhoi.png" alt=""></a></td>
                                            <td><a onclick="return confirm('Bạn muốn xóa thông báo này?');" href="./teacher-xulixoathongbao.php?id=<?php echo $records['id']; ?>"><img width="30px;" src="../images/icon_huy.png" alt=""></a></td>
                                        </tr>
                                        <?php
                                        $sothutu+=1;
                                    }
